                        ...
                        <div id="storeCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="/images/penican-1.png" class="d-block w-100" alt="Carousel1" />
                                </div>
                                <div class="carousel-item">
                                    <img src="/images/penican-2.png" class="d-block w-100" alt="Carousel2" />
                                </div>
                                <div class="carousel-item">
                                    <img src="/images/penican-3.png" class="d-block w-100" alt="Carousel3" />
                                </div>
                                <div class="carousel-item">
                                    <img src="/images/penican-4.png" class="d-block w-100" alt="Carousel4" />
                                </div>
                                <div class="carousel-item">
                                    <img src="/images/penican-5.png" class="d-block w-100" alt="Carousel5" />
                                </div>
                                <div class="carousel-item">
                                    <img src="/images/penican-6.png" class="d-block w-100" alt="Carousel6" />
                                </div>
                            </div>
                        </div>
                    </div>
